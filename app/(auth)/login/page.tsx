	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			...
			if (code === 'auth/configuration-not-found') {
				setError('Firebase Authentication is not properly configured. See console for details and check QUICK_SETUP.md');
				console.error('❌ Firebase Auth configuration error!');
				console.error('');
				console.error('This error means your Firebase configuration doesn\'t match your project.');
				console.error('');
				console.error('📋 Quick Fix Steps:');
				console.error('1. Get your Firebase config from Firebase Console → Project Settings → Your apps');
				console.error('2. Update lib/firebase.ts with your new configuration values');
				console.error('3. Enable Authentication in Firebase Console → Authentication → Sign-in method');
				console.error('4. Restart your development server');
				console.error('');
				console.error('📖 See QUICK_SETUP.md for detailed instructions');
				console.error('');
				console.error('Current configuration being used:');
				console.error('  - Check lib/firebase.ts for the current Firebase config');
				console.error('  - Make sure it matches your Firebase project settings');
